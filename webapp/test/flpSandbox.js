		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "workthroughproject",
									"targetURL": "#comexampleworkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleworkthrough-display": {
								"semanticObject": "comexampleworkthrough",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.workthrough",
									"url": sap.ui.require.toUrl("com/example/workthrough")
								}
							}
						}
					}
